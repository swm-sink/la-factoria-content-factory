...
class SmartAIContext:
    ...
    def clean_ai_context_files(self) -> bool:
        ...
        logger.info("🧹 Cleaning existing AI context files...")
    ...
    def clean_and_regenerate(self) -> bool:
        ...
        logger.info("🚀 Regenerating all AI context files...")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Smart AI Context Generator")
    parser.add_argument(
        "--clean", 
        action="store_true", 
    ...
    if args.clean_only:
        print("🧹 Cleaning AI context files only...")
        generator.clean_ai_context_files()
        print("✅ Clean complete!")
        return
    
    if args.clean:
        print("🔄 Clean regeneration mode activated...")
        success = generator.clean_and_regenerate()
        if success:
            print("✅ Clean regeneration complete!")
        else:
            print("❌ Clean regeneration encountered issues")
    else:
        generator.run()
