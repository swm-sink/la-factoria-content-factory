...
class ExportRequestSchema(BaseModel):
    ...
    format: ExportFormat = Field(..., description="Export format", examples=[ExportFormat.PDF])
...
class BulkExportRequestSchema(BaseModel):
    ...
    max_items: int = Field(default=1000, ge=1, le=10000, description="Maximum number of items to export")
