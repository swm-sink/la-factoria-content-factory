...
PARALLEL_EXECUTION_TIME = Histogram(
    "parallel_execution_duration_seconds", "Time spent on parallel execution"
)
PARALLEL_TASKS_COMPLETED = Counter(
    "parallel_tasks_completed_total", "Total parallel tasks completed"
)
PARALLEL_TASKS_FAILED = Counter(
    "parallel_tasks_failed_total", "Total parallel tasks failed"
)
...
class ParallelProcessor:
    ...
    async def _execute_async_task_with_timing(
        self, task: Awaitable, task_id: str
    ) -> TaskResult:
